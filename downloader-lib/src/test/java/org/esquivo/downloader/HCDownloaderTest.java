...
public class HCDownloaderTest {
	...
	public void TimeoutOptionsMustThrowException() throws IOException {
		...
		options.put(BufferedHCDownloader.CONNECTION_TIMEOUT, 500);
		options.put(BufferedHCDownloader.READ_TIMEOUT, 500);
		BufferedHCDownloader down = new BufferedHCDownloader(options);
	...
	public void NullHttpEntityGetsNullFile() throws MalformedURLException,
		...
		BufferedHCDownloader down = new BufferedHCDownloader() {
			@Override
